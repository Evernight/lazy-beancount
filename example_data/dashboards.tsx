    ...
    },
    {
      ...
      panels: [
        ...
        },
        {
          ...
          kind: "html",
          spec: async () => `
            <p>Balance charts need regularly occurring transactions to generate data points for price conversions (beanquery limitation).
            Use <code>beancount_interpolate.recur</code> with <code>Equity:RegularTransacionForSummariesFrom</code> / <code>Equity:RegularTransacionForSummariesTo</code> (see regular_postings_fix.bean).
            </p>
            <p>Balance charts can show vertical marker lines for <code>chart_note</code> events. Add events with <code>"chart_note"</code> type.</p>
          `,
        },
        {
          title: "Net Worth",
